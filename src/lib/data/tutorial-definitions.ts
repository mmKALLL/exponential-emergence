...
export const tutorialMessages: TutorialMessage[] = [
  ...
  {
    id: 'multi-multiply',
    trigger: { type: 'actionUnlocked', actionName: 'New Action: Multiply' },
  ...
  {
    id: 'multi-filter',
    trigger: { type: 'actionUnlocked', actionName: 'New Action: Filter waste' },
    title: 'Filter waste',
  ...
  },
  {
    ...
    trigger: { type: 'levelStart', level: 'insect' },
